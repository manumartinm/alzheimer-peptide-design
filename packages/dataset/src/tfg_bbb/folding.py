...
def rebuild_manifest_from_experiments(
    ...
    *,
    ...
    """Import manifest rows from succeeded Boltz runs only (no API calls)."""
...
def build_struct_manifest(
    ...
    *,
    ...
    """Fold unique peptide sequences and write a structural manifest parquet."""
    cfg = fold_cfg or FoldConfig()
    exp_dir = experiments_dir or structures_dir.parent.parent / cfg.experiments_dir
    if manifest_only:
        return rebuild_manifest_from_experiments(
            df,
