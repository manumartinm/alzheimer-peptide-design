...
class ESMTab3DFeatModel(nn.Module):
    def __init__(self, d_esm: int, d_tab: int, d_3d: int, hidden_dim: int = 256, dropout: float = 0.2):
        super().__init__()
    ...
    def forward(self, esm: torch.Tensor, tab: torch.Tensor, feat3d: torch.Tensor | None = None, **kwargs) -> torch.Tensor:
